...
def test_v111_release_metadata_is_consistent() -> None:
    ...
    assert release_url() == (
        "https://github.com/3154638220/ashare-hotpot/releases/tag/v1.1.1"
    )
    assert "AshareHotPot-Setup-1.1.1-x64.exe" in readme
