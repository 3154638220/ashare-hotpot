...
def test_v112_release_metadata_is_consistent() -> None:
    ...
    assert release_url() == (
        "https://github.com/3154638220/ashare-hotpot/releases/tag/v1.1.2"
    )
    assert "AshareHotPot-Setup-1.1.2-x64.exe" in readme
