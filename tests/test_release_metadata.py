...
EXPECTED_RELEASE_VERSION = "1.2.2"
PROJECT_ROOT = Path(__file__).resolve().parents[1]


def test_v122_release_metadata_is_consistent() -> None:
    ...
    assert release_url() == (
        "https://github.com/3154638220/ashare-hotpot/releases/tag/v1.2.2"
    )
    assert "AshareHotPot-Setup-1.2.2-x64.exe" in readme
